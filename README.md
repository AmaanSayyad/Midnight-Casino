...
| Website feedback form | https://midnight-casino-eta.vercel.app/feedback — **feedback was collected on our site** (not Google Forms) |
| Public sheet (CSV) | [`docs/feedback-sheet.csv`](docs/feedback-sheet.csv) |
