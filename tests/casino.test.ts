/**
 * Rise In Level 1+ tests for Midnight Casino Compact.
 * Delegates to the midnight-contract Vitest suite (9 tests).
 * Covers: circuit logic, state transitions, private inputs never exposed.
 */
import { describe, it, expect, beforeEach } from 'vitest';
import {
  CasinoSimulator,
  RoundStatus,
} from '../midnight-contract/test/casino-simulator.js';

const sk = () => new Uint8Array(32).fill(7);
const otherSk = () => new Uint8Array(32).fill(9);
const salt = () => new Uint8Array(32).fill(3);

describe('Rise In — casino.compact privacy gates', () => {
