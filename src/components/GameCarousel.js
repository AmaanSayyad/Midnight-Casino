...
const FEATURED_GAMES = [
  ...
  },
  {
    id: 'privacy-wheel',
    title: 'Privacy Wheel',
    description: 'Compact ZK bets — private choice, public commitment',
    image: '/images/games/spin_the_wheel.png',
    path: '/game/privacy-wheel',
    players: 42,
    categories: ['featured', 'midnight'],
    badge: 'MIDNIGHT',
    badgeColor: 'from-violet-700/80 to-fuchsia-600/80',
    isNew: true,
    isHot: true,
  },
  {
