  ...
  const features = [
    {
      ...
      description: "Privacy Wheel uses Midnight Compact commit-reveal and selective disclosure. Arcade games use local entropy for UX while Compact remains the fairness surface.",
      icon: "🎲"
    },
    {
      id: 2,
